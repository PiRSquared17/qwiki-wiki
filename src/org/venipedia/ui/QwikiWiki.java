...
public class QwikiWiki {
	...
	private void initialize() {
		...
		mnDatabase.setIcon(new ImageIcon(QwikiWiki.class
		...
		mntmConnectToRemote.setIcon(new ImageIcon(QwikiWiki.class
		...
		mntmSaveDataXml.setIcon(new ImageIcon(QwikiWiki.class
		...
		mntmViewRecordTable.setIcon(new ImageIcon(QwikiWiki.class
		...
		mntmVenipediaInWindow.setIcon(new ImageIcon(QwikiWiki.class
		...
		mntmVenipediaInBrowser.setIcon(new ImageIcon(QwikiWiki.class
		...
		mntmAbout.setIcon(new ImageIcon(QwikiWiki.class
